...
int main()
{
    vector<double> vect5(5), vect10(10), vect25(25), vect50(50), vect100(100);
	  srand(time(NULL));
    ...
    mergeSort(vect10, 0, vect5.size());
    mergeSort(vect25, 0, vect5.size());
    mergeSort(vect50, 0, vect5.size());
    mergeSort(vect100, 0, vect5.size());
